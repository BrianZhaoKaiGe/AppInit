          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                :class="{active:spuSaleAttrValue.isChecked == 1}">{{spuSaleAttrValue.saleAttrValueName}}</dd>

              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input @change="changeSkuNum" autocomplete="off" class="itxt" v-model.number="skuNum">
                <a href="javascript:" @click="skuNum++" class="plus">+</a>
                <a href="javascript:" @click="skuNum>1?skuNum--:skuNum=1" class="mins">-</a>
              </div>
              <div class="add">
