    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html" v-html="good.title"></a>
                  </div>
                  <div class="commit">
          ...
          <!-- 分页 -->
          <Pagination @getPageNo='getPageNo' :pageNo=searchParams.pageNo :pageSize=searchParams.pageSize :total=parseInt(totals) :continues='5'></Pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    isDesc(){
     ...
     ...mapState({
      totals: (state) => state.search.searchList.total,
    }),
  },
  created() {
  },
  methods: {
    ...
    console.log('aaaa', typeof this.totals);
